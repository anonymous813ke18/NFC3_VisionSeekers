    ...
    <div class="ui container">
        ...
        <div class="ui grid">
            ...
            <div class="twelve wide column">
                <h1 style="text-align: center; background-color: #fff; border-radius: 10px">Send a Gift</h1>
                <br>
                <?php
                    if(isset($_POST['submit_gift'])) {
                        ...
                        if ($conn->query($sql) === TRUE) {
                            $unsponsored_page = './old-gallery-unsponsored.php';
                ...
                <form action="<?php $_PHP_SELF ?>" method="post" class="ui form">
                    <h4 class="ui dividing header">Old Age House's Details</h4>
                    <?php
                        if(isset($_GET['cid'])) {
                            $cid = $_GET['cid'];
                        }
                        $sql = "SELECT cid, cname, cyoe, cclass FROM old WHERE cid='$cid' ";
                    ...
                    <div class="description">
                        <div class="ui horizontal list">
                            ...
                            <div class="item">
                                <div class="content">
                                <div>Address:</div> <strong><?php echo $row["cclass"]; ?></strong>
                                </div>
                            </div>
                            <div class="item">
                                <div class="content">
